...
void CQChip8Test::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CQChip8Test *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CQChip8Test::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_CQChip8Test.data,
    qt_meta_data_CQChip8Test,
    qt_static_metacall,
    nullptr,
    nullptr
} };
